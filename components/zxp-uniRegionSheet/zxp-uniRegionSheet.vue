	...
	<view class="view-modal" v-if="showSheetView" :class="[modalAnimation?'ani_start':'ani_end']"
			...
			<view class="bread-view">
				<slot v-for="(item,index) in breadList">
					<text :class="[index===breadList.length-1?'hilight-text':'']"
						@click.stop="breadClickedAction(index)">{{item.name}}</text>
			...
			<view class="cnts-view">
				<scroll-view scroll-y="true" class="sview-1" :style="{ transform: `translateX(${anispace}vw)`}">
					<view class="column-view colum-line" v-for="(item,index) in drawerList" :key="index"
						...
						<text class="single-line" :class="[index===col1Index?'hilight-text':null]">{{item.name}}</text>
						<image v-if="index===col1Index" style="width: 30upx;height: 30upx;color: #0286df;" class="cuIcon-check"></image>
					</view>
				</scroll-view>
				<scroll-view scroll-y="true" class="sview-2" :style="{transform: `translateX(${anispace}vw)`}">
					<view class="column-view colum-line" v-for="(item,index) in dataList[col1Index].list" :key="index"
						@click.stop="cellClickedAction(2,index)">
						<text class="single-line"
							:class="[index===col2Index?'hilight-text':null]">{{item.name}}</text>
						<image v-if="index===col2Index" style="width: 30upx;height: 30upx;color: #0286df;" class="cuIcon-check"></image>
					</view>
				</scroll-view>
				<scroll-view scroll-y="true" class="sview-3" :style="{transform: `translateX(${anispace}vw)`}">
					<view class="column-view" v-for="(item,index) in dataList[col1Index].list[col2Index].list"
						:key="index" @click.stop="cellClickedAction(3,index)">
						<text class="single-line"
							:class="[index===col3Index?'hilight-text':null]">{{item.name}}</text>
						<image v-if="index===col3Index" style="width: 30upx;height: 30upx;color: #0286df;" class="cuIcon-check"></image>
					</view>
				</scroll-view>
			</view>
		</view>
		<view v-else class="sheet-view" :class="[modalAnimation?'ani-top':'ani-btm']">
			...
			<picker-view :indicator-style="indicatorStyle" :value="selValue" @change="bindChange" class="picker-view">
				<picker-view-column>
					<view class="column-item" v-for="(item,index) in dataList" :key="index">{{item.name}}</view>
				</picker-view-column>
				<picker-view-column>
					<view class="column-item" v-for="(item,index) in dataList[col1Index].list" :key="index">{{item.name}}
					</view>
				</picker-view-column>
				<picker-view-column>
					<view class="column-item" v-for="(item,index) in dataList[col1Index].list[col2Index].list" :key="index">
						{{item.name}}
					</view>
				</picker-view-column>
			</picker-view>
